    ...
    <body>
        ...
        <?php
            ...
            $select = "SELECT * from hasil_kuisioner inner join dosen on hasil_kuisioner.id_dosen=dosen.id_dosen inner join kuisioner on hasil_kuisioner.id_soal=kuisioner.id_soal GROUP BY hasil_kuisioner.id_dosen";
